...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Byte_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.String), typeof(System.Byte).MakeByRefType()};
            method = type.GetMethod("TryParse", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TryParse_9);
            args = new Type[]{typeof(System.String), typeof(System.Globalization.NumberStyles), typeof(System.IFormatProvider), typeof(System.Byte).MakeByRefType()};
            method = type.GetMethod("TryParse", flag, null, args, null);
        ...
        static System.Byte GetInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, List<object> __mStack)
        {
                ...
                case ObjectTypes.FieldReference:
                    {
                        ...
                        {
                            instance_of_this_method = (System.Byte)((ILTypeInstance)instance_of_fieldReference)[ptr_of_this_method->ValueLow];
                        }
                        else
                        {
                            var t = __domain.GetType(instance_of_fieldReference.GetType()) as CLRType;
                            instance_of_this_method = (System.Byte)t.GetField(ptr_of_this_method->ValueLow).GetValue(instance_of_fieldReference);
                        }
                    }
                    break;
                case ObjectTypes.StaticFieldReference:
                    {
                        ...
                        if(t is ILType)
                        {
                            instance_of_this_method = (System.Byte)((ILType)t).StaticInstance[ptr_of_this_method->ValueLow];
                        }
                        else
                        {
                            instance_of_this_method = (System.Byte)((CLRType)t).GetField(ptr_of_this_method->ValueLow).GetValue(null);
                        }
                    }
                    break;
        ...
        static StackObject* Parse_5(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Byte.Parse(s, provider);
        ...
        static StackObject* Parse_6(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Byte.Parse(s, style);
        ...
        static StackObject* Parse_7(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Byte.Parse(s, style, provider);
        ...
        static StackObject* Parse_8(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Byte.Parse(s);
        ...
        static StackObject* TryParse_9(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            System.Byte result = (byte)ptr_of_this_method->Value;
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.String s = (System.String)typeof(System.String).CheckCLRTypes(__domain, StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            var result_of_this_method = System.Byte.TryParse(s, out result);
        ...
        static StackObject* TryParse_10(ILIntepreter __intp, StackObject* __esp, List<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = System.Byte.TryParse(s, style, provider, out result);
